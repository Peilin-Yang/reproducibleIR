...
class DAOPlay extends DAO {
    ...
    const SQL_GET_PERTUBE_EVALUATION = "SELECT e.evaluate_status, e.pertube_type, e.pertube_paras_str, e.performances, q.name, m.mname FROM evaluation as e, models as m, query_paths as q WHERE e.mid=:mid and m.mid=:mid and q.query_tag=e.query_tag and e.pertube_type!=0";
