...
<html>
<head>
    <title><?php echo htmlentities(SITENAME." Judge List"); ?></title>
...
<body>
  <?php require_once ($_SERVER["DOCUMENT_ROOT"]."/treccs_summary_judge/common/navbar.php"); ?>
	<div style="display:none;">
	  <p id="cur_uid"><?php echo $_SESSION['uid']; ?></p>
	  <p id="cur_apikey"><?php echo $_SESSION['apikey']; ?></p>
    <p id="cur_year"><?php echo $_GET['year']; ?></p>
    <p id="cur_page"><?php if (isset($_GET['page'])) echo $_GET['page']; else echo "1";?></p>
	</div>
<div class="container">
  <h3><i class="fa fa-list-ul fa-6x fa-fw"></i><strong>TREC Contextual Suggestion <?php echo $_GET['year']; ?> </strong></h3>
...
<script type="text/javascript" src="../static/js/judge_list.js"></script>
